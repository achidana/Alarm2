 ...
 * This is just a template, updating piece by piece to suit our needs
 */
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button mVerifyPhoneButton = (Button) findViewById(R.id.verifyPhoneButton);
        mVerifyPhoneButton.setOnClickListener(new OnClickListener() {
            @Override
